...
const Home = ({ email, setEmail }) => {
  ...
  return (
    <div className={styles.appContainer}>
      ...
      <div
        className={`${styles.formContainer} relative z-10 bg-gray-800 p-10 rounded-xl shadow-xl max-w-lg w-full backdrop-blur-md bg-opacity-60  flex flex-col justify-center items-center space-y-4 mt-[4rem]`}
      >
